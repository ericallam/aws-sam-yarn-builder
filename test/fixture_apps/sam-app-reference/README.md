...
This is a sample template for sam-app-reference - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam-app-reference --query 'Stacks[].Outputs'
```
